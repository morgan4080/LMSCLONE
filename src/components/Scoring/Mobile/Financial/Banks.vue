...
const loadBankTransReceivedData = async () => {
  await axiosInstance
    .get(
      `/e_statement/pay_bill_classifications_received?statementRefId=${route.params.slug}&pageSize=100&sortBy=id`
    )
    .then(
      response =>
...
const loadBankTransSentData = async () => {
  await axiosInstance
    .get(
      `/e_statement/pay_bill_classifications_sent?statementRefId=${route.params.slug}&pageSize=100&sortBy=id`
    )
    .then(
      response =>
...
const loadBankTopAccountsData = async () => {
  await axiosInstance
    .get(
      `/e_statement/top_bank_accounts?statementRefId=${route.params.slug}&pageSize=100&sortBy=id`
    )
...
const loadBankTopTransData = async () => {
  await axiosInstance
    ...
    .get(
      `/e_statement/top_paybill_classifications?statementRefId=${route.params.slug}&classification=Banks&pageSize=${itemsPerPage.value}&sortBy=id`
    )
