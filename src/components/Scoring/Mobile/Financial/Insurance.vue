...
const loadInsuranceTransReceivedData = async () => {
  await axiosInstance
    .get(
      `/e_statement/pay_bill_classifications_received?statementRefId=${route.params.slug}&classification=Insurance&pageSize=100&sortBy=id`
    )
    .then(
...
const loadInsuranceTransSentData = async () => {
  await axiosInstance
    .get(
      `/e_statement/pay_bill_classifications_sent?statementRefId=${route.params.slug}&classification=Insurance&pageSize=100&sortBy=id`
    )
...
const loadInsuranceTopTransData = async () => {
  await axiosInstance
    .get(
      `/e_statement/top_paybill_classifications?statementRefId=${route.params.slug}&classification=Insurance&pageSize=${itemsPerPage.value}&sortBy=id`
    )
