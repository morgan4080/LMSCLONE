            ...
            <v-container fluid>
              ...
              <div class="my-8 mx-4">
                ...
                <v-row class="justify-space-between d-flex">
                  ...
                  <v-col>{{ remittanceTransReceivedData[0]?.highest }}</v-col>
                  <v-col>{{ remittanceTransSentData[0]?.highest }}</v-col>
                </v-row>
                ...
                <v-row class="justify-space-between d-flex">
                  ...
                  <v-col>{{ remittanceTransReceivedData[0]?.lowest }}</v-col>
                  <v-col>{{ remittanceTransSentData[0]?.lowest }}</v-col>
                </v-row>
                <v-divider class="my-2" />
                <v-row class="justify-space-between d-flex">
                ...
                <v-row class="font-weight-bold justify-space-between d-flex">
                  <v-col>Total</v-col>
                  <v-col>{{ remittanceTransReceivedData[0]?.total }}</v-col>
                  <v-col>{{ remittanceTransSentData[0]?.total }}</v-col>
                </v-row>
              </div>
            </v-container>
          </v-card>
