...
const loadEntertainmentTransBuyGoodsData = async () => {
  await axiosInstance
    .get(
      `/e_statement/buy_goods_classifications_summary?statementRefId=${route.params.slug}&classification=Entertainment&pageSize=100&sortBy=id`
    )
    .then(
...
const loadEntertainmentTopTransData = async () => {
  await axiosInstance
    .get(
      `/e_statement/top_paybill_classifications?statementRefId=${route.params.slug}&classification=Entertainment&pageSize=${itemsPerPage.value}&sortBy=id`
    )
            ...
            <v-container fluid>
              <div class="mx-4">
                ...
                <h2 class="text-caption text-grey-darken-2 font-weight-regular">
                  Summary of Entertainment Transactions
                </h2>
              </div>
              <div class="mx-4 my-8">
      ...
      <!--      <v-row>
        <v-container fluid>
          ...
          >
            <div class="px-8">
              <h1 class="text-h6 font-weight-regular">
                Top Entertainment Transactions
              </h1>
              <h2 class="text-caption text-grey-darken-2 font-weight-regular">
                Summary of Entertainment Transactions
              </h2>
