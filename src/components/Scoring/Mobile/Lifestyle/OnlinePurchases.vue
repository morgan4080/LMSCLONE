            ...
            <v-container fluid>
              ...
              <div class="my-8 mx-4">
                ...
                <v-row class="justify-space-between d-flex">
                  ...
                  <v-col>{{ onlinePurchases.count.received }}</v-col>
                  <v-col>{{ onlinePurchases.count.paid }}</v-col>
                </v-row>
                <v-divider class="my-2" />
                <v-row class="justify-space-between d-flex">
                  <v-col class="font-weight-medium">Highest</v-col>
                  <v-col>{{ onlinePurchases.highest.received }}</v-col>
                  <v-col>{{ onlinePurchases.highest.paid }}</v-col>
                </v-row>
                <v-divider class="my-2" />
                <v-row class="justify-space-between d-flex">
                  <v-col class="font-weight-medium">Lowest</v-col>
                  <v-col>{{ onlinePurchases.lowest.received }}</v-col>
                  <v-col>{{ onlinePurchases.lowest.paid }}</v-col>
                </v-row>
                <v-divider class="my-2" />
                <v-row class="justify-space-between d-flex">
                  <v-col class="font-weight-medium">Last</v-col>
                  <v-col>{{ onlinePurchases.last.received }}</v-col>
                  <v-col>{{ onlinePurchases.last.paid }}</v-col>
                </v-row>
                <v-divider
                  class="my-3"
                  :thickness="3"
                ...
                <v-row class="font-weight-bold justify-space-between d-flex">
                  <v-col>Total</v-col>
                  <v-col>{{ onlinePurchases.total.received }}</v-col>
                  <v-col>{{ onlinePurchases.total.paid }}</v-col>
                </v-row>
              </div>
            </v-container>
          </v-card>
