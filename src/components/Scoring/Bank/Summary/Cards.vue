          ...
          <div class="mx-4">
            ...
            >
              ...
              <div class="my-10">
                ...
                ></v-divider>
                <div class="d-flex justify-space-between mt-4">
                  <h1 class="text-caption font-weight-bold">Gross Monthly Income</h1>
                  <h1 class="text-caption">{{analysis.grossIncome}}</h1>
                </div>
                <v-divider class="my-2"></v-divider>
                <div class="d-flex justify-space-between mt-4">
                  <h1 class="text-caption font-weight-bold">Net Monthly Income</h1>
                  <h1 class="text-caption">{{analysis.netIncome}}</h1>
                </div>
                <v-divider class="my-2"></v-divider>
                <div class="d-flex justify-space-between mt-4">
                  <h1 class="text-caption font-weight-bold">Max Loanable (R) P.M.</h1>
