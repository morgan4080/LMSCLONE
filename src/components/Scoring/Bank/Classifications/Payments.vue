            ...
            <v-container fluid>
              ...
              <div class="mx-4 my-8">
                ...
                <v-row class="justify-space-between d-flex">
                  <v-col class="font-weight-medium">Total</v-col>
                  <v-col class="text-right">{{
                    formatter(flowCashWithdrawal[0]?.total)
                  }}</v-col>
                </v-row>
                <v-divider class="my-2" />
                <v-row class="justify-space-between d-flex">
                  <v-col class="font-weight-medium">Highest</v-col>
                  <v-col class="text-right">{{
                    formatter(flowCashWithdrawal[0]?.highest)
                  }}</v-col>
                </v-row>
                <v-divider
                  :thickness="3"
                ...
                <v-row class="justify-space-between d-flex">
                  <v-col class="font-weight-medium">Last On</v-col>
                  <v-col class="text-right">{{
                    flowCashWithdrawal[0]?.last_draw
                  }}</v-col>
                </v-row>
                <v-divider class="my-3" />
              </div>
            ...
            <v-container fluid>
              ...
              <div class="mx-4 my-8">
                ...
                <v-row class="justify-space-between d-flex">
                  <v-col class="font-weight-medium">Total</v-col>
                  <v-col class="text-right">{{
                    formatter(flowReversals[0]?.total)
                  }}</v-col>
                </v-row>
                <v-divider class="my-2" />
                <v-row class="justify-space-between d-flex">
                  <v-col class="font-weight-medium">Highest</v-col>
                  <v-col class="text-right">{{
                    formatter(flowReversals[0]?.highest)
                  }}</v-col>
                </v-row>
                <v-divider
                  :thickness="3"
            ...
            <v-container fluid>
              ...
              <div class="mx-4 my-8">
                ...
                <v-row class="justify-space-between d-flex">
                  <v-col class="font-weight-medium">Highest</v-col>
                  <v-col class="text-right">{{
                    formatter(flowOthers[0]?.highest)
                  }}</v-col>
                </v-row>
                <v-divider
                  :thickness="3"
            ...
            <v-container fluid>
              <div class="my-2 d-flex justify-space-between">
                <div>
                  ...
                  &lt;!&ndash;                  <v-menu transition="slide-y-transition">
                    <template v-slot:activator="{ props }">
                      <v-btn
                        size="small"
                        variant="outlined"
...
const currentOutflowType = ref<optionTypes>(options[0]);
        ...
        <v-col class="my-2">
          ...
          >
            <v-container fluid>
              <div class="mx-4">
                <h1 class="text-h6 font-weight-regular">
                  Cash Deposit & Cheque Withdrawal
                </h1>
                <h2 class="text-caption text-grey-darken-2 font-weight-regular">
                  Summary Of Cash Deposit & Cheque Withdrawal
                </h2>
              </div>
              <div class="mx-4 my-8">
                <v-row class="justify-space-between d-flex font-weight-bold">
        ...
        <v-col class="my-2">
          ...
          >
            <v-container fluid>
              <div class="mx-4">
                <h1 class="text-h6 font-weight-regular">
                  Card Payment & ATM Withdrawals
                </h1>
                <h2 class="text-caption text-grey-darken-2 font-weight-regular">
                  Summary Of Card Payment & ATM Withdrawals
                </h2>
              </div>
              <div class="mx-4 my-8">
                <v-row class="justify-space-between d-flex font-weight-bold">
